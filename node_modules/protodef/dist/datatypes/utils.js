...
var _require = require("../utils"),
    getField = _require.getField,
    getCount = _require.getCount,
    sendCount = _require.sendCount,
    calcCount = _require.calcCount,
    tryDoc = _require.tryDoc,
    PartialReadError = _require.PartialReadError;
...
function readPString(buffer, offset, typeArgs, rootNode) {
  var _getCount$call = getCount.call(this, buffer, offset, typeArgs, rootNode),
      size = _getCount$call.size,
      count = _getCount$call.count;
...
function readBuffer(buffer, offset, typeArgs, rootNode) {
  var _getCount$call2 = getCount.call(this, buffer, offset, typeArgs, rootNode),
      size = _getCount$call2.size,
      count = _getCount$call2.count;
...
function readBitField(buffer, offset, typeArgs) {
  ...
  var bits = 0;
  var results = {};
  results.value = typeArgs.reduce(function (acc, _ref4) {
    var size = _ref4.size,
        signed = _ref4.signed,
        name = _ref4.name;
...
function writeBitField(value, buffer, offset, typeArgs) {
  var toWrite = 0;
  var bits = 0;
  typeArgs.forEach(function (_ref5) {
    var size = _ref5.size,
        signed = _ref5.signed,
        name = _ref5.name;
...
function sizeOfBitField(value, typeArgs) {
  return Math.ceil(typeArgs.reduce(function (acc, _ref6) {
    var size = _ref6.size;
