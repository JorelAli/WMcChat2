...
var _require = require('../utils'),
    ...
    getFieldInfo = _require.getFieldInfo,
...
function readSwitch(buffer, offset, _ref, rootNode) {
  ...
  var compareTo = _ref.compareTo,
      fields = _ref.fields,
      compareToValue = _ref.compareToValue,
      rest = _objectWithoutProperties(_ref, ['compareTo', 'fields', 'compareToValue']);
...
function writeSwitch(value, buffer, offset, _ref2, rootNode) {
  ...
  var compareTo = _ref2.compareTo,
      fields = _ref2.fields,
      compareToValue = _ref2.compareToValue,
      rest = _objectWithoutProperties(_ref2, ['compareTo', 'fields', 'compareToValue']);
...
function sizeOfSwitch(value, _ref3, rootNode) {
  ...
  var compareTo = _ref3.compareTo,
      fields = _ref3.fields,
      compareToValue = _ref3.compareToValue,
      rest = _objectWithoutProperties(_ref3, ['compareTo', 'fields', 'compareToValue']);
